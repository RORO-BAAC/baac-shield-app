    ...
    <div style={{ display: "grid", gap: 14 }}>
      ...
      <div>
        ...
        />
          ...
          <div>
  <label>Daily Job Scope / Work Plan</label>
  <br />
  <textarea
    value={toolboxDailyScope}
    onChange={(e) => setToolboxDailyScope(e.target.value)}
    rows="3"
    placeholder="Describe today's planned work scope"
    style={{
      width: "100%",
      padding: 12,
      marginTop: 6,
...
<div>
  <label>Locates # + Expiry Dates</label>
  <br />
  <textarea
    value={toolboxLocates}
    onChange={(e) => setToolboxLocates(e.target.value)}
    rows="2"
    placeholder="List locate numbers and expiry dates"
    style={{
      width: "100%",
      padding: 12,
      marginTop: 6,
...
<div>
  ...
  <br />
  <input
    value={toolboxMusterPoint}
    onChange={(e) => setToolboxMusterPoint(e.target.value)}
    placeholder="Emergency muster point"
    style={{
      width: "100%",
      padding: 12,
      marginTop: 6,
...
<div>
  ...
  <br />
  <input
    value={toolboxEmergencyNumber}
    onChange={(e) => setToolboxEmergencyNumber(e.target.value)}
...
<div>
  ...
  <br />
  <input
    value={toolboxNearestHospital}
    onChange={(e) => setToolboxNearestHospital(e.target.value)}
    placeholder="Nearest hospital or emergency facility"
    style={{
      width: "100%",
      padding: 12,
      marginTop: 6,
...
<div>
  <label># First Aid Attendants</label>
  <br />
  <input
    value={toolboxFirstAidAttendants}
    onChange={(e) => setToolboxFirstAidAttendants(e.target.value)}
    placeholder="Number or names of first aid attendants"
    style={{
      width: "100%",
      padding: 12,
      marginTop: 6,
